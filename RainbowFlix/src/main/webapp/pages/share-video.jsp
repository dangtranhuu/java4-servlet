...
@media ( min-width : 64em) {
	...
	<div class="content">
		<form class="col-sm-12" action="/RainbowFlix/share-video" method="post">
			<div class="col-sm-6">
				<div class="form-group">
					<label for="email">Email người nhận</label> <input
						style="background-color: #343A40 !important" type="text"
						class="form-control" placeholder="Enter email" name="email">
						
						<input
						style="background-color: #343A40 !important; display: none" type="text"
						class="form-control" placeholder="Enter email" name="url" value="${url }">
				</div>
				<div class="form-group">
					<label for="pwd">Tên người gửi</label> <input type="text"
						class="form-control" placeholder="Enter password" name="shareby"
			...
			<div class="col-sm-6">
				<div class="form-group">
					<label for="email">Tiêu đề</label> <input
						style="background-color: #343A40 !important" type="text"
						class="form-control" placeholder="Enter email" name="subject">
				</div>
				<div class="form-group">
					<label for="pwd">Nội dung</label> <input type="text"
						class="form-control" placeholder="Email" name="body">
				</div>
